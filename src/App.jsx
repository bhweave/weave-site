...
function HomePage({ setPage, openProduct }) {
  ...
  <div className="order-1 flex items-center justify-center md:order-2">
    <img src="/logo.svg" alt="WEAVE logo" className="h-64 w-64 invert object-contain md:h-80 md:w-80" />
  </div>
</section>
  ...
  return (
    <>
      <main>
        ...
        <section id="categories" className="mx-auto max-w-7xl px-6 py-10 md:py-14">
          <div className="mb-6">
        ...
        <section id="products" className="mx-auto max-w-7xl px-6 pb-16 pt-4 md:pb-24">
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
